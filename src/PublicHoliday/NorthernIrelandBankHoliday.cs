...
namespace PublicHoliday
{
    public class NorthernIrelandBankHoliday : UKBankHoliday
    {
        ...
        /// <returns></returns>
        public static new DateTime Christmas(int year)
        {
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public static new DateTime BoxingDay(int year)
        {
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public static new DateTime NewYear(int year)
        {
            //since 1974 only
        ...
        public static new DateTime? MayDay(int year)
        {
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public static new DateTime Spring(int year)
        {
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public static new DateTime Summer(int year)
        {
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public static new DateTime GoodFriday(int year)
        {
        ...
        /// <param name="year"></param>
        /// <returns></returns>
        public static new DateTime EasterMonday(int year)
        {
            DateTime hol = HolidayCalculator.GetEaster(year);
            hol = hol.AddDays(1);
            return hol;
        ...
        public virtual new bool IsBankHoliday(DateTime dt)
        {
